...
void stepMotor_anticlockwise_90degrees(){
    ...
    PORTCbits.RC0 = 0; PORTCbits.RC1 = 0; PORTCbits.RC2 = 1; PORTCbits.RC4 = 1;
    _delay((unsigned long)((delay_quantity)*(20000000/4000.0)));
# 45 "main.c"
}

void stepMotor_clockwise_90degrees(){
# 58 "main.c"
    PORTCbits.RC0 = 0; PORTCbits.RC1 = 1; PORTCbits.RC2 = 1; PORTCbits.RC4 = 0;
    _delay((unsigned long)((delay_quantity)*(20000000/4000.0)));
# 72 "main.c"
}
